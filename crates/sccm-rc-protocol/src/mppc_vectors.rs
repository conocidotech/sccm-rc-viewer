//! FreeRDP MPPC RDP5/64K ground-truth vector (TestFreeRDPCodecMppc.c).
//! Decompress RDP5_COMPRESSED (at_front+compressed) => RDP5_UNCOMPRESSED.

pub(crate) const RDP5_COMPRESSED: &[u8] = &[
...
pub(crate) const RDP5_UNCOMPRESSED: &[u8] = &[
